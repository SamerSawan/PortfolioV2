...
import { faGithub, faFile } from '@fortawesome/free-brands-svg-icons';
import { faArrowRight } from '@fortawesome/free-solid-svg-icons'; // Add this line
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="mt-20">
        ...
        <div className="space-x-12 ml-12">
          ...
          <Button icon={faFile} text="Resume" />
        </div>

        <div className="text-honeydew text-2xl mt-10">
